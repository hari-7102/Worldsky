    ...
    <div className='px-16 py-10'>
        ...
        <div className='flex flex-col items-center justify-center'>
          ...
          {/* <p className='flex text-xl max-w-3xl text-gray-600 mx-36 mt-8 items-start'>Get the best Value fro Your trips with exclusive discounts, seasonal promotions and deals to save whole exploring the World</p> */}
            ...
            <div className=' my-24   bg-[url("https://hblimg.mmtcdn.com/content/hubble/img/dest_img/mmt/activities/m_rome_destination_main_1_l_667_1000.jpg")] w-4/5  h-[31rem] bg-cover relative rounded-2xl '>
                <p className='bg-[url("https://hblimg.mmtcdn.com/content/hubble/img/destimg/mmt/activities/m_Florence_destination_landscape_1_l_538_717.jpg")]  bg-cover w-80 h-64 rounded-xl absolute -bottom-24 -right-24  '></p>
              <div className='flex items-center gap-2 absolute p-4  '>
                <MapPin size={26}  />
