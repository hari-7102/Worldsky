  ...
  return (
    <div className="md:px-20 px-5  py-4  md:py-11 flex flex-wrap lg:flex-nowrap">
      ...
      className="md:w-1/2  w-full  ">
        <p className="md:text-6xl  text-5xl     text-black font-serif">
          Book a Journey{" "}
        </p>
        <p className=" text-4xl   md:text-5xl text-black mt-2 font-serif">
      ...
      className="md:w-1/2 md:px-14     w-full md:py-0 py-16 ">
        <div className="border focus:border-gray-700        border-gray-300 rounded-2xl p-7">
          ...
          <button className="text-center w-full py-2 bg-blue-600 text-white rounded-lg mt-5">
            Send Message ....
          </button>
        </div>
      </motion.div>
